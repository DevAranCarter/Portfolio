...
const Projects = () => {
  return (
    <Container id="projects" pt={{base:'600px', md:'10px', lg:'10px'}}>
      ...
      >
        <VStack w="full" h="full" alignItems={"flex-start"} p={2} pt={{base:'30px'}}>
        <Heading>Web3 Website</Heading>
        </VStack>
        <VStack w="full" h="full" alignItems={"center"} p={2} pt={{base:'30px'}}>
        <Heading>Project 2</Heading>
        </VStack>
        <VStack w="full" h="full" alignItems={"flex-end"} p={2} pt={{base:'30px'}}>
        <Heading>Project 3</Heading>
        <LinkBox as='image' maxW='sm' p='5' borderWidth='1px' rounded='md'></LinkBox>
        </VStack>
        </Flex>
        </Container>
  );
